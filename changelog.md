...
- 支持通过merge.json自动合并规则 (__@Ianzb__)
- 京东 (__@Yuu518 @Ianzb__)
- 美团 (__@Yuu518 @Ianzb__)
- 闲鱼 (__@Yuu518__)
- 淘宝 (__@Yuu518__)
...
- MT管理器 (__@Yuu518 @Ianzb__)
- MT管理器（测试版） (__@Yuu518 @Ianzb__)
- 爱玩机工具箱 (__@Yuu518__)
- 米游社 (__@Yuu518__)
- 森空岛 (__@Yuu518__)
- 哔哩哔哩 (__@Yuu518__)
...
- 现在会将官方配置和模块配置文件单独上传一份到服务器，并临时禁用模块zip打包 (__@Ianzb__)
...
- 同步官方260520配置文件 (__@Ianzb__)
- 修复规则合并脚本的一处逻辑错误 (__@Ianzb__)
